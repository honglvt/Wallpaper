package com.xieaoze.novawallpaper.utils;
...
public class CommonUtil {
    ...
    public static Typeface findFont(Context context, String fontPath, String defaultFontPath) {
        ...
        if (cachedFontMap.containsKey(fontName)) {
            ...
            try {
                ...
                LogUtil.e(String.format("Unable to find %s font. Using Typeface.DEFAULT instead.", fontName));
    ...
    public static void saveImage(Context context, Bitmap bmp) {
        String storePath = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "Nova Wallpaper";
