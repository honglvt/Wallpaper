package com.xieaoze.novawallpaper.widget;
...
public class FancyButton extends LinearLayout {
    ...
    private int mDefaultTextSize = CommonUtil.spToPx(getContext(), 15);
    private int mDefaultTextGravity = 0x11; // Gravity.CENTER
    private String mText = null;

    // # Icon Attributes
    private Drawable mIconResource = null;
    private int mFontIconSize = CommonUtil.spToPx(getContext(), 15);
    ...
    public FancyButton(Context context) {
        ...
        mTextTypeFace = CommonUtil.findFont(mContext, mDefaultTextFont, null);
        mIconTypeFace = CommonUtil.findFont(mContext, mDefaultIconFont, null);
    ...
    private TextView setupTextView() {
        ...
        textView.setTextSize(CommonUtil.pxToSp(getContext(), mDefaultTextSize));
    ...
    private TextView setupFontIconView() {
        ...
        if (mFontIcon != null) {
            ...
            if (!isInEditMode()) {
                fontIconView.setTextSize(CommonUtil.pxToSp(getContext(), mFontIconSize));
    ...
    private void initAttributesArray(TypedArray attrsArray) {
        ...
        if (!isInEditMode()) {
            mIconTypeFace = iconFontFamily != null
                    ? CommonUtil.findFont(mContext, iconFontFamily, mDefaultIconFont)
                    : CommonUtil.findFont(mContext, mDefaultIconFont, null);
            ...
            if (fontResource != null) {
                ...
                mTextTypeFace = textFontFamily != null
                        ? CommonUtil.findFont(mContext, textFontFamily, mDefaultTextFont)
                        : CommonUtil.findFont(mContext, mDefaultTextFont, null);
            }
        }
    }
    ...
    public void setTextSize(int textSize) {
        this.mDefaultTextSize = CommonUtil.spToPx(getContext(), textSize);
        if (mTextView != null)
    ...
    public void setFontIconSize(int iconSize) {
        this.mFontIconSize = CommonUtil.spToPx(getContext(), iconSize);
        if (mFontIconView != null)
    ...
    public void setCustomTextFont(String fontName) {
        mTextTypeFace = CommonUtil.findFont(mContext, fontName, mDefaultTextFont);
    ...
    public void setCustomIconFont(String fontName) {
        ...
        mIconTypeFace = CommonUtil.findFont(mContext, fontName, mDefaultIconFont);
